...
class GraphApi {
    ...
    initAllModels(){
        for(let name in this.models){
            ...
            // this.models[name].queryInputName      = `${CapModelName}WhereInput`;
            // this.models[name].querySingleName     = `get${CapModelName}`;
            // this.models[name].queryAllName        = `get${PluralCapModelName}`;
            //
            //
            // this.models[name].mutationCreateName  = `create${CapModelName}`;
            // this.models[name].mutationUpdateName  = `update${CapModelName}`;
            // this.models[name].mutationDeleteName  = `delete${CapModelName}`;
            //
            // this.models[name].mutationCreateInputName= `${CapModelName}CreateInput`;
            // this.models[name].mutationUpdateInputName= `${CapModelName}UpdateInput`;
            // this.models[name].mutationUpdateWhereInputName= `${CapModelName}UpdateWhereInput`;
            // this.models[name].mutationDeleteWhereInputName= `${CapModelName}DeleteWhereInput`;
        }
    }
    ...
    composeTypesAndResolvers(){
        ...
        for(let key in this.models){
            ...
            inputTypes += `input ${model.queryWhereInputName} { \n`;
    ...
    makeRowStr(name, model, options){
        ...
        str += `where: ${model.queryWhereInputName},`;
    ...
    loadCreateMutation(model){
        if(!model.mutationCreate){
            console.log('no model', model.name)
            return;
        }
        console.log('model', model.name)
        switch (model.type) {
            case 'sequelize':
                SequelizeHelper.addCreateMutation(this, model);
                break;
            case 'mongoose':
                MongooseHelper.addCreateMutation(this, model);
                break;
            default:
                break;
        }
