...
const MongooseHelper2 = require('./mongooseHelper2');
...
class GraphApi {
    ...
    initMongoose1(){
      ...
      for(let key in models){
        ...
        let associations = MongooseHelper.loadAssociations(this, model);
        let attributes   = MongooseHelper.loadAttributes(this, model);
    ...
    initMongoose(){
        ...
        let allModels = MongooseHelper2.AbstractAllModels(someModels);
